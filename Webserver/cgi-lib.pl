...
$cgi_lib'maxdata    = 2097152;    # maximum bytes to accept via POST - (2Mb)
$cgi_lib'writefiles =    ".";    # directory to which to write files, or
                                 # 0 if files should not be written
$cgi_lib'filepre    = "UPLOADED-"; # Prefix of file names, in directory above
